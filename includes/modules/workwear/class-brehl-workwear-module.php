...
final class Brehl_Workwear_Module {
    ...
    public function handle_cancellation(): void {
        ...
        $id=absint($_REQUEST['order_id']??0); check_admin_referer('brehl_cancel_workwear_'.$id);
        global $wpdb;
