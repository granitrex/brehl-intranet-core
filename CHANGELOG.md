...
- Ausgehändigte Bestellungen werden bei Mitarbeitern und Personalverwaltung automatisch archiviert.
- Umschaltung zwischen aktuellen Bestellungen und Archiv ergänzt.
- Vorhandene Teststatus werden automatisch auf Bestellt vereinheitlicht.
...
- Artikel können sicher ein- oder ausgeblendet sowie in Name, Nummer, Kategorie und Größen bearbeitet werden.
- Artikelbilder können im Frontend hochgeladen und im Bestellformular angezeigt werden.
...
- Funktioniert unabhängig davon, ob das optionale Profil-Aufklappmenü aktiviert ist.
